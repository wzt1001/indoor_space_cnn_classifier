...
import densenet_torchvision as densenet
...
def main():
    ...
    parser.add_argument('--save', default='/media/ztwang/ssd_0/data/indoor_space_cnn_classifier/scripts/work/new')
    ...
    data_indoor = np.load(args.split)
    data_train = data_indoor['data_train'][:10000].astype(np.float32)
    # data_train = data_indoor['data_train'].astype(np.float32)
    data_train = data_train.reshape((data_train.shape[0], 3, 224, 224))
    print(data_train.shape)
    data_train = torch.from_numpy(data_train)
    label_train = data_indoor['label_train'][:10000]
